...
| RF-08 | Correlation Engine agrupa eventos (Rust) | – | – | – | – | Pendiente — responsable: LT |
| RF-09 | Attack Reconstruction produce AttackTrace (Rust) | – | – | – | – | Pendiente — responsable: LT |
...
- Estado: `Pendiente` / `En progreso` / `Cubierto`. Actualizar en cada sprint (ver `docs/scrum/`).
