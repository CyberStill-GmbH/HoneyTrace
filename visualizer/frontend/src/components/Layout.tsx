...
export function Layout() {
  ...
  return <div className="app-shell">
    <aside className="sidebar" data-open={open} aria-label="Navegación principal">
      <div className="brand-block"><img className="sidebar-logo" src="/honeytrace-logo.svg" alt="HoneyTrace" /><button className="icon-button mobile-close-button ml-auto" aria-label="Cerrar navegación" onClick={() => setOpen(false)}><X size={18} /></button></div>
